...
HELP: dict[str, str] = {
    ...
    "DCF_GROWTH_CAP": "Upper cap on historical FCF growth used in the projection (decimal).",
    ...
    return [
        ...
        {"section": "API rate limits", "fields": rate_limits},
        {
            ...
            "fields": [
                ...
                _field("DCF_GROWTH_CAP", "FCF growth cap", "float", lo=0.0, hi=1.0, step=0.01, group="DCF"),
