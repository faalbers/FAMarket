...
PARAM_HINTS: dict[str, dict] = {
    ...
    "div": {
        ...
        "how_to_use": [
            ...
            "Trend growth %/yr — a steadier alternative to CAGR, fit across the full ~5-year window instead of just the two endpoints.",
            "Feeds the DDM intrinsic value (trend growth, capped at 15%).",
        ],
    ...
    "intrinsic_value_ddm": {
        ...
        "category": "Intrinsic Value",
        "unit": "$",
        "what_it_is": "Dividend discount model: trailing per-share dividend projected 10 years at its trend growth rate (log-linear fit, capped 15%), discounted at risk-free + beta × 5% (same rate as the DCF), plus terminal value.",
        "how_to_use": [
            ...
            "Only meaningful for real dividend payers; NULL for non-payers. A shrinking dividend is floored to 0% growth, same as the DCF.",
        ],
        "vs_peers": "No — compare price to value.",
    },
